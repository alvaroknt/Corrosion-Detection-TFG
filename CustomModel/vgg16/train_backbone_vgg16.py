...
class VGG16BinaryClassifier(nn.Module):
    def __init__(self):
        ...
        # Decoder: progressive upsampling and convolution layers
...
def BB_VGG16(loss="BCE", alpha=1, gamma=2, num_epochs=10, batch_size=4,
    ...
    # TODO: Replace with actual dataset paths or mount Google Drive if using Colab
    train_image_dir = "/path/to/train/images"
    train_mask_dir = "/path/to/train/masks"
    test_image_dir = "/path/to/test/images"
    test_mask_dir = "/path/to/test/masks"

    # Standard normalization for pretrained models (ImageNet)

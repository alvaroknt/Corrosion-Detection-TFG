# DeepLabV3+/resnet50/train_deeplabv3_resnet50.py
...
def DL_ResNet50(loss="BCE", alpha=1, gamma=2, num_epochs=10, batch_size=4,
                shuffle_train=True, shuffle_test=False, model_name="DeepLabV3Plus_ResNet50"):
